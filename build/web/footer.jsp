...
<div class="container text-center text-md-left mt-5">
  ...
  <div class="row mt-3">
    ...
    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
      <!-- Content -->
      <h6 class="text-uppercase font-weight-bold">poterie</h6>
      <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;background-color: #6351ce;">
      <p>soyer le bienvenue dans notre applicaion web pour la gestion des produit(poterie)</p>
    </div>
    <!-- Grid column -->
    <!-- Grid column -->
    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
      ...
      <p>
        <a href="listePoterie">liste poterie</a>
      </p>
      <p>
    ...
    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
      ...
      <p>
        <i class="fas fa-envelope mr-3"></i> poterie@appweb.com</p>
      <p>
